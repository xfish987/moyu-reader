...
import { MAX_SECTION_GAP, countSpinesHiddenForExpansion, coverCountForShelf, coverWidthForShelf, layoutShelfBooks, moveBeforeOrAfter, orderBooksByIds, shortSpineTitle, spineMetrics } from './src/ui-b/shelfLayout.js'
