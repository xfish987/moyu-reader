...
contextBridge.exposeInMainWorld('readerAPI', {
  ...
  translateChapter: (payload) => ipcRenderer.invoke('ai:translate-chapter', payload),
  cancelTranslation: (requestId) => ipcRenderer.invoke('ai:cancel-translation', requestId),
  translateTerm: (payload) => ipcRenderer.invoke('ai:translate-term', payload),
  ...
  getCloudStatus: (serverUrl) => ipcRenderer.invoke('cloud:status', serverUrl),
  registerCloudAccount: (payload) => ipcRenderer.invoke('cloud:register', payload),
  loginCloudAccount: (payload) => ipcRenderer.invoke('cloud:login', payload),
  logoutCloudAccount: () => ipcRenderer.invoke('cloud:logout'),
  changeCloudPassword: (payload) => ipcRenderer.invoke('cloud:change-password', payload),
  chooseCloudAvatar: () => ipcRenderer.invoke('cloud:choose-avatar'),
  updateCloudProfile: (payload) => ipcRenderer.invoke('cloud:update-profile', payload),
  exportCloudAccount: () => ipcRenderer.invoke('cloud:export-account'),
  clearCloudAccount: (confirmation) => ipcRenderer.invoke('cloud:clear-account', confirmation),
  deleteCloudAccount: (confirmation) => ipcRenderer.invoke('cloud:delete-account', confirmation),
  uploadCloudSnapshot: () => ipcRenderer.invoke('cloud:upload'),
  restoreCloudSnapshot: () => ipcRenderer.invoke('cloud:restore-snapshot'),
  syncCloudData: () => ipcRenderer.invoke('cloud:sync-data'),
  getCloudTranslationData: () => ipcRenderer.invoke('cloud:translation-get'),
  saveCloudTranslationData: (data) => ipcRenderer.invoke('cloud:translation-save', data),
  syncOverview: () => ipcRenderer.invoke('cloud:sync-overview'),
  listCloudLibrary: () => ipcRenderer.invoke('cloud:library-list'),
  uploadCloudLibrary: () => ipcRenderer.invoke('cloud:library-upload-all'),
  downloadCloudLibraryBook: (book) => ipcRenderer.invoke('cloud:library-download', book),
  deleteCloudLibraryBook: (book) => ipcRenderer.invoke('cloud:library-delete', book),
  onCloudLibraryProgress: (callback) => {
    const listener = (_event, progress) => callback(progress)
    ipcRenderer.on('cloud:library-progress', listener)
    return () => ipcRenderer.removeListener('cloud:library-progress', listener)
  },
  listStoreBooks: (filters) => ipcRenderer.invoke('cloud:store-list', filters),
  chooseStoreUpload: () => ipcRenderer.invoke('cloud:store-choose-upload'),
  uploadStoreBook: (payload) => ipcRenderer.invoke('cloud:store-upload', payload),
  downloadStoreBook: (book) => ipcRenderer.invoke('cloud:store-download', book),
  updateStoreBookCategory: (payload) => ipcRenderer.invoke('cloud:store-update-category', payload),
  deleteStoreBook: (id) => ipcRenderer.invoke('cloud:store-delete', id),
  reviewStoreBook: (payload) => ipcRenderer.invoke('cloud:store-review', payload),
  deleteStoreReview: (id) => ipcRenderer.invoke('cloud:store-review-delete', id),
  storeBookCover: (id) => ipcRenderer.invoke('cloud:store-cover', id),
  listReaderThoughts: (bookKey) => ipcRenderer.invoke('cloud:thoughts-list', bookKey),
  createReaderThought: (payload) => ipcRenderer.invoke('cloud:thought-create', payload),
  deleteReaderThought: (thoughtId) => ipcRenderer.invoke('cloud:thought-delete', thoughtId),
  likeReaderThought: (thoughtId) => ipcRenderer.invoke('cloud:thought-like', thoughtId),
  replyReaderThought: (payload) => ipcRenderer.invoke('cloud:thought-reply', payload),
  deleteReaderThoughtReply: (payload) => ipcRenderer.invoke('cloud:thought-reply-delete', payload),
