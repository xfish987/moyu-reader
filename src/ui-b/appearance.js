...
export const DEFAULT_APPEARANCE = {
  ...
  home: { ...DEFAULT_BACKGROUND, opacity: 0.6, blurPx: 0, overlayOpacity: 0.05, saturation: 0.95, contrast: 1.08, positionX: 76, positionY: 45, asset: themeHomeBackground('mist'), enabled: true },
